...
## Loader
หลังจากผู้ใช้งานมีปฎิสัมพันธ์กับระบบ ผู้ใช้งานเริ่มรู้สึกว่าต้องรอเมื่อเวลาผ่านไปมากกว่า 1 วินาทีแล้วยังไม่ได้รับข้อมูลที่ต้องการ การใช้งาน Loader คือการบอกผู้ใช้งานว่าเขาจะต้องรอการทำงานของระบบก่อนจึงจะสามารถใช้งานต่อไปได้
