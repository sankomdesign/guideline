...
### How to use
ใช้เพื่อเลือกสิ่งที่ผู้ใช้งานต้องการ แต่การใช้งาน Selection Control แต่ละชนิดนั้น มีวัตถุประสงค์ในการใช้ไม่เหมือนกันดังนี้
| Component   | Objective            | Response              |
| ----------- | -------------------- | --------------------- |
| Checkbox    | เลือกได้หลายตัวเลือก     | ไม่มีผลจนกว่าจะกดยืนยัน    |
| Radio       | เลือกเพียงหนึ่งตัวเลือก    | ไม่มีผลจนกว่าจะกดยืนยัน    |
| Switch      | ใช้กับสิ่งที่มีผลตรงข้ามกัน เช่น เปิด-ปิด, ถูก-ผิด เป็นต้น | มีผลทันทีที่กด |
